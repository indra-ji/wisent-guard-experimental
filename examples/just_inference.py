...
def main():
    ...
    detector_file = detector_files.get(
        args.detector_type, "hallucination_detection_data.csv"
    )
    ...
    if not os.path.exists(detector_path):
        ...
        print(
            f"Run the corresponding detect_{args.detector_type}.py script first to create training data."
        )
        return
