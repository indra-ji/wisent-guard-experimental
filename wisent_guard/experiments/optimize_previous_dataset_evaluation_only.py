...
def evaluate_classifier(
    ...
    for agg_method in aggregation_methods:
        ...
        if aggregated_scores:
            ...
            print(
                f"      ✅ {agg_method}: Best threshold={best_threshold:.3f}, Accuracy={best_accuracy:.3f}, F1={best_metrics['f1']:.3f}, N={best_metrics['n_samples']}"
            )
        else:
    ...
    try:
        ...
        for layer in sorted(all_results.keys()):
            ...
            for method, metrics in layer_results.items():
                ...
                print(
                    f"   {method:>8}: Acc={accuracy:.3f}, F1={f1:.3f}, Thresh={threshold:.2f}, N={n_samples}"
                )
