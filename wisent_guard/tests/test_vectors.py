...
class TestContrastiveVectors:
    ...
    def test_vectors_initialization(self):
        ...
        vectors = ContrastiveVectors(
            model_name="distilbert/distilgpt2", layers=[0, 1], save_dir=self.test_dir
        )
    ...
    def test_create_pair_set(self):
        ...
        vectors = ContrastiveVectors(
            model_name="distilbert/distilgpt2", layers=[0], save_dir=self.test_dir
        )
    ...
    def test_get_similarity_basic(self):
        ...
        similarity = vectors.get_similarity(
            text="Some test text", category="test_pairs", layer_idx=0
        )
    ...
    def test_vectors_storage_structure(self):
        ...
        # Create pair set
        vectors.create_pair_set(
            name="test_pairs", harmful_texts=["Bad"], harmless_texts=["Good"]
        )
    ...
    def test_layer_configuration(self):
        ...
        vectors_multi = ContrastiveVectors(
            model_name="distilbert/distilgpt2", layers=[0, 1, 2], save_dir=self.test_dir
        )
    ...
    def test_save_directory_creation(self):
        ...
        vectors = ContrastiveVectors(
            model_name="distilbert/distilgpt2", layers=[0], save_dir=nested_path
        )
