...
class SimplifiedSampleSizeOptimizer:
            ...
            pipeline_args.update(
                {
                    ...
                    "steering_strength": self.method_kwargs.get(
                        "steering_strength", 1.0
                    ),
                    "token_targeting_strategy": self.method_kwargs.get(
    ...
    def run_optimization(self) -> Dict[str, Any]:
        ...
        logger.info(
            f"Model: {self.model_name}, Task: {self.task_name}, Layer: {self.layer}"
        )
        ...
        return {
            ...
            "optimal_accuracy": self.results["accuracies"][optimal_idx]
            if optimal_idx >= 0
            else None,
            "optimal_f1_score": self.results["f1_scores"][optimal_idx]
            if optimal_idx >= 0
            else None,
    ...
    **method_kwargs,
    ...
    if save_plot:
        ...
        plot_path = os.path.join(
            plot_dir, f"{task_name}_{method_type}_layer{layer}_{timestamp}.png"
        )
