...
class LiveCodeBenchVersionManager:
    ...
    def get_version_difference(
        self, base_version: str, target_version: str, use_cache: bool = True
    ) -> VersionDifference:
        """
    ...
    def get_version_split(
        self, train_version: str, eval_version: str, split_type: str = "new_only"
        ...
        return {"train": train_problems, "eval": eval_problems}
            ...
            analysis["progression"].append(
                {
                    ...
                    "added_problems": added_problems,
                    "growth_rate": added_problems / prev_version["problems"]
                    if prev_version["problems"] > 0
                    else 0,
                }
            )
