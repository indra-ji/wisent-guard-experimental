...
class NonsenseDetector:
    ...
    def __init__(
        ...
        if self.enable_dictionary_check:
            try:
                ...
                print(
                    "Warning: Could not load NLTK words corpus. Dictionary check disabled."
                )
    ...
    def _check_phrase_repetition(self, words: List[str]) -> Dict[str, Any]:
        ...
        return {"score": max_score, "repeated_phrases": repeated_phrases}
...
def evaluate_response_quality(
    response: str, detector: Optional[NonsenseDetector] = None
) -> Dict[str, Any]:
    """
