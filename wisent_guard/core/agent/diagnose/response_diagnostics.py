...
class ResponseDiagnostics:
    ...
    async def analyze_response(self, response: str, prompt: str) -> AnalysisResult:
        ...
        if not confidence_scores:
            ...
            confidence = sum(result["confidence"] for result in classifier_results) / len(classifier_results) if classifier_results else 0.5
        else:
    ...
    def decide_if_improvement_needed(self, analysis: AnalysisResult, 
