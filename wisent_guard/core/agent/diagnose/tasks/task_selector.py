...
class TaskSelector:
    ...
    def find_relevant_tasks_for_issue_type(
        self, issue_type: str, max_tasks: int = 10
    ) -> List[str]:
        """
    ...
    def select_best_tasks_for_training(
        ...
        relevant_tasks = self.find_relevant_tasks_for_issue_type(
            issue_type, max_tasks * 2
        )
...
def find_relevant_tasks_for_issue_type(
    issue_type: str, max_tasks: int = 10, model=None
) -> List[str]:
