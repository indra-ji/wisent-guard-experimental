...
class ModelConfigManager:
    ...
    def get_optimal_sample_size(
        self, model_name: str, task_name: str, layer: int
    ) -> Optional[int]:
        """
            ...
            if filename.endswith(".json"):
                try:
                    ...
                    summary = {
                        ...
                        "optimization_method": config_data.get(
                            "optimization_method", "unknown"
                        ),
                        "classification_layer": config_data.get(
                            "optimal_parameters", {}
                        ).get("classification_layer"),
                        "steering_layer": config_data.get("optimal_parameters", {}).get(
                            "steering_layer"
                        ),
